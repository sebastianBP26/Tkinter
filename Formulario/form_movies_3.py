...
class Application(tk.Tk):
    ...
    def validate_fields(self, title, genre, rate, year, format, price):
        if title == '' or genre == '' or rate == '' or year == '' or format == '' or price == '':
            validation = False
        else:
            validation = True
    ...
    def add_movie(self):
        ...
        if self.validate_fields(title, genre, rate, year, format, price):
            ...
            self.result_label.config(text = 'Porfavor, completa todos los datos.')
